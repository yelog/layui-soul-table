...
<template>
  <div class="page-container page-resource">
    ...
    <!--<div class="resource-placeholder">-->
      <!--<img src="~documents/assets/images/resource-placeholder.svg" alt="">-->
    ...
    <div class="cards">
      <ul class="container">
        <li>
          <div class="card">
            <img src="~documents/assets/images/Axure-Components.svg" alt="">
        ...
        <li>
          <div class="card">
            <img src="~documents/assets/images/Sketch-Template.svg" alt="">
        ...
        <!--<li>-->
          <!--<div class="card">-->
            <!--<img src="~documents/assets/images/Module.svg" alt="">-->
