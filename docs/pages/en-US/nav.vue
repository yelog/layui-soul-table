    ...
    <div class="block">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="15" class="nav-demos">
          <img src="~docs/assets/images/navbar_1.png" alt="Level 1 categories" @click="enlarge(846, $event)">
          <h5>Level 1 categories</h5>
          <p>Suitable for simply structured sites with only one level of pages. No breadcrumb is needed.</p>
          <img src="~docs/assets/images/navbar_2.png" alt="Level 2 categories" @click="enlarge(846, $event)">
          ...
          <img src="~docs/assets/images/navbar_3.png" alt="Level 3 categories" @click="enlarge(846, $event)">
    ...
    <div class="block">
      ...
      <el-row>
        ...
        <el-col :span="14" class="nav-demos">
          <img src="~docs/assets/images/navbar_0.png" alt="" @click="enlarge(846, $event)">
