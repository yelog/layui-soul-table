...
<template>
  <div class="page-container page-resource">
    ...
    <!--<div class="resource-placeholder">-->
      <!--<img src="~docs/assets/images/resource-placeholder.svg" alt="">-->
      <!--<h4>整理中</h4>-->
      <!--<p>设计资源正在整理和完善中</p>-->
    <!--</div>-->
    ...
    <div class="cards">
      <ul class="container">
        <li>
          <div class="card">
            <img src="~docs/assets/images/Axure-Components.svg" alt="">
        ...
        <li>
          <div class="card">
            <img src="~docs/assets/images/Sketch-Template.svg" alt="">
        ...
        <!--<li>-->
          <!--<div class="card">-->
            <!--<img src="~docs/assets/images/Module.svg" alt="">-->
            <!--<h3>组件交互文档</h3>-->
